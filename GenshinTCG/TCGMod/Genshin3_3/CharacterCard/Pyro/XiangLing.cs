    ...
    public class XiangLing : AbstractCardCharacter
    {
        ...
        private class 旋火轮 : AbstractCardSkill
        {
            ...
            private class 火轮 : AbstractCardPersistentEffect
            {
                ...
                {
                    { SenderTag.AfterUseSkill.ToString(),(me, p, s, v) => { if(s is UseSkillSender ski && ski.Skill is not 旋火轮) { me.Enemy.Hurt(new DamageVariable(3, 2, 0), this); p.AvailableTimes --; } }}
                };
