namespace TCGBase
{
    public abstract class AbstractCustomTriggerable : ITriggerable, INameable
    {
        ...
        public abstract void Trigger(AbstractTeam me, Persistent persitent, AbstractSender sender, AbstractVariable? variable);
    }
    public abstract class AbstractCustomSkillTriggerable : AbstractTriggerableSkill
    {
        ...
        /// </summary>
        public abstract void AfterUseAction(AbstractTeam me, Persistent persitent, AbstractSender sender, AbstractVariable? variable);
        /// <summary>
        /// CustomSkillTriggerable已经自动封装Trigger，只需要在AfterUseAction中写出需要发生的事情即可
        /// </summary>
        public sealed override void Trigger(AbstractTeam me, Persistent persitent, AbstractSender sender, AbstractVariable? variable)
