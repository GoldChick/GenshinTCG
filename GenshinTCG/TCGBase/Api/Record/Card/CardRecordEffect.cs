namespace TCGBase
{
    public record CardRecordEffect : CardRecordBase
    {
        ...
        public CardRecordEffect(string nameID, List<string> skillList, int maxUseTimes, int initialUseTimes = -1, List<string>? tags = null, bool hidden = false, CardType cardtype = CardType.Effect) : base(nameID, hidden, cardtype, skillList, tags)
        {
