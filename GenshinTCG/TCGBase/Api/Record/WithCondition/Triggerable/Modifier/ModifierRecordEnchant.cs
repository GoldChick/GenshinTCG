...
namespace TCGBase
{
    public record class ModifierRecordEnchant : ModifierRecordBase
    {
        ...
        public ModifierRecordEnchant(DamageElement element = DamageElement.Trival, bool fromdata = true,  int consume = 1, List<ConditionRecordBase>? when = null, ActionRecordTrigger? trigger = null) : base(ModifierType.Enchant, 0, consume, when, trigger)
        {
            Element = element;
            FromData = fromdata;
        }
