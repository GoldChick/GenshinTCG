...
namespace TCGBase
{
    ...
    public record class ActionRecordEffect : ActionRecordBaseWithTarget
    {
        ...
        public ActionRecordEffect(EffectFatherType father = EffectFatherType.None, List<string>? add = null, List<string>? remove = null, List<string>? update = null, TargetRecord? target = null, List<ConditionRecordBase>? when = null) : base(TriggerType.Effect, target, when)
        {
            Father = father;
            Add = add ?? new();
            Remove = remove ?? new();
                    ...
                    switch (card.CardType)
                    {
                        ...
                        case CardType.Effect:
                            ...
                            else
                            {
                                chars.ForEach(c =>
                                {
                                    if (c is Character cha && cha.Effects.Contains(card))
                                    {
