namespace TCGBase
{
    ...
    public class PreHurtSender : AbstractSender
    {
        ...
        public AbstractTriggerable RootSource { get; init; }
        /// <summary>
        /// 记录被打的角色头上的本来的元素，用来区分不同的结晶、扩散
        /// </summary>
        public int InitialElement { get; }
        internal PreHurtSender(int teamID, AbstractTriggerable triggerable, SenderTag sender, int initialelement = -1) : base(teamID)
        {
